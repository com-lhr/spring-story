...
<script language="javascript">
	...
	function GetDateNow() {
		...
		var num=str.indexOf("="); //第一个=处
		var num3=str.lastIndexOf("="); //最后一个=处
		var str1=str.substr(num+1); 
		var num2=str1.indexOf("&"); //第一个&处
		//console.info(num2);
		var str3 = str1.substr(0,num2); //商品编号
		//console.info(str1)
		var str2=str.substr(num3+1);  //商品价格
	...
	function add(){
		var id = $(" input[ name='WIDout_trade_no' ] ").val();
		alert(id);
...
>>>>>>> branch 'master' of https://github.com/com-lhr/spring-story.git
</html>