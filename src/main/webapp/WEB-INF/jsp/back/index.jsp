...
<head>
    <title>敏捷后台模板</title>
    <link rel="stylesheet" href="back/js/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="back/css/font-awesome.min.css">
    <link rel="stylesheet" href="back/css/index.css">
    <link rel="stylesheet" href="back/css/skins/_all-skins.css">
</head>
<body class="hold-transition skin-blue sidebar-mini" style="overflow:hidden;">
    <div id="ajax-loader" style="cursor: progress; position: fixed; top: -50%; left: -50%; width: 200%; height: 200%; background: #fff; z-index: 10000; overflow: hidden;">
        <img src="back/img/ajax-loader.gif" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; margin: auto;" />
    </div>
    <div class="wrapper">
        <!--头部信息-->
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li class="divider"></li>
                                <li><a><i class="ace-icon fa fa-power-off"></i>安全退出</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <div class="content-tabs">
                ...
                <nav class="page-tabs menuTabs">
                    <div class="page-tabs-content" style="margin-left: 0px;">
                        <a href="javascript:;" class="menuTab active" data-id="log">欢迎首页</a>
                    </div>
                </nav>
    ...
    <script src="back/js/jquery/jQuery-2.2.0.min.js"></script>
    <script src="back/js/bootstrap/js/bootstrap.min.js"></script>
